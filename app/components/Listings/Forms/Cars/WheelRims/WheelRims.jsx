            ...
            >
                            ...
                            <RadioComponent
                                ...
                                onChange={(event) => {
                                    setListingDetails({
                                        ...listingDetails,
                                        [String(WheelRimsJson[0].labelEn).toLocaleLowerCase()]: {
                                            ...listingDetails[String(WheelRimsJson[0].labelEn).toLocaleLowerCase()],
                ...
                <div className={`${classes.Size} rounded bg-white`}>
                    <h3 className={"uppercase"}>
                        {lang === "en" ? WheelRimsJson[1].labelEn : WheelRimsJson[1].labelAr}
                    </h3>
                    <div className={"flex justify-start gap-2 flex-wrap"}>
                        <input
                            type="text"
                            placeholder={lang === "en" ? WheelRimsJson[1].labelEn : WheelRimsJson[1].labelAr}
                            autoComplete="off"
                            value={listingDetails[String(WheelRimsJson[1].labelEn).toLocaleLowerCase()].value}
                            onChange={(e) => {
                                setListingDetails({
                                    ...listingDetails,
                                    [String(WheelRimsJson[1].labelEn).toLocaleLowerCase()]: {
                                        ...listingDetails[String(WheelRimsJson[1].labelEn).toLocaleLowerCase()],
                ...
                <div className={`${classes.Brand} rounded bg-white`}>
                    <h3 className={"uppercase"}>
                        {lang === "en" ? WheelRimsJson[2].labelEn : WheelRimsJson[2].labelAr}
                    </h3>
                    <div className={"flex justify-start gap-2 flex-wrap"}>
                        <DropDown
                            value={listingDetails[String(WheelRimsJson[2].labelEn).toLocaleLowerCase()].value}
                            onChange={(value) => {
                                setListingDetails({
                                    ...listingDetails,
                                    [String(WheelRimsJson[2].labelEn).toLocaleLowerCase()]: {
                                        ...listingDetails[String(WheelRimsJson[2].labelEn).toLocaleLowerCase()],
                                        value: value.value,
                                    },
                            })}}
                            options={brandsOptions}
                            filter={true}
                            placeholder={lang === "en" ? WheelRimsJson[2].labelEn : WheelRimsJson[2].labelAr}
                        />
                    </div>
                </div>
