...
const ContactInfo = ({imgSrc, imgAlt, children}) => {
    return (
        ...
        <div className="flex flex-col text-sm font-medium leading-5 text-white whitespace-nowrap max-md:mt-10">
...
const ContactPage = () => {
    return (
        <section className="flex justify-center items-center py-12 bg-transparent max-md:px-5">
            <section
                className="flex flex-col items-center px-20 py-12 my-12 w-full bg-sky-500 rounded-md max-md:px-5 max-md:mt-10 max-md:max-w-full">
                <header className="flex gap-0 mt-12 text-sm text-white whitespace-nowrap max-md:mt-10">
                    <div className="w-1 h-[23px]"/>
                    <div className="justify-center px-2.5 py-1 aspect-[3.09] bg-gray-200 bg-opacity-10">Contact</div>
                </header>

                <h1 className="mt-3.5 text-4xl font-semibold text-center text-white whitespace-nowrap">Get in touch with us</h1>
                ...
                <form className="flex flex-row justify-between flex-wrap gap-4 p-8 rounded-md max-w-[750px] mx-auto w-full bg-transparent border-0">
