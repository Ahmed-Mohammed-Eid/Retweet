		...
		<div className={classes.AccountHomeContent}>
			...
			<div className={classes.AccountHomeContent__Body}>
				<div className={classes.AccountHomeContent__Body__Card}>
					...
					/>
					<h2>{lang === "en" ? "Promoted" : "تم الترويج"}</h2>
				</div>
				<div className={classes.AccountHomeContent__Body__Card}>
					<PercentageCircle
						percentage={
					...
					/>
					<h2>{lang === "en" ? "Pending" : "قيد الانتظار"}</h2>
				</div>
				<div className={classes.AccountHomeContent__Body__Card}>
					<PercentageCircle
						percentage={
					...
					/>
					<h2>{lang === "en" ? "Rejected" : "تم الرفض"}</h2>
				</div>
				<div className={classes.AccountHomeContent__Body__Card}>
					<PercentageCircle
						percentage={100}
				...
				{/* <div className={classes.AccountHomeContent__Body__Card}>
					<PercentageCircle
						...
						bgColor={"rgba(255, 59, 59, 0.4)"}
					/>
					<h2>{lang === "en" ? "Deleted" : "تم الحذف"}</h2>
				</div> */}
			</div>
		</div>
	);
